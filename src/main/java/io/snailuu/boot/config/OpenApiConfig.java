...
import io.snailuu.boot.config.properties.OpenApiProperties;
...
public class OpenApiConfig {
    ...
    private static String AUTH_PACKAGE = "io.snailuu.boot.auth";
    private static String SYSTEM_PACKAGE = "io.snailuu.boot.system";
    private static String USER_PACKAGE = "io.snailuu.boot.user";
    private static String COMMON_PACKAGE = "io.snailuu.boot.common";
    private static String GENERATOR_PACKAGE = "io.snailuu.boot.generator";
