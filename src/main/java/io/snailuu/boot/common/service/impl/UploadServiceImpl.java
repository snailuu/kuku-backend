...
import io.snailuu.boot.auth.util.CommonLoginUtil;
import io.snailuu.boot.common.constant.UploadConstant;
import io.snailuu.boot.common.enums.FileServerType;
import io.snailuu.boot.common.enums.SysFileType;
import io.snailuu.boot.common.enums.SystemType;
import io.snailuu.boot.common.enums.UploadType;
import io.snailuu.boot.common.service.UploadService;
import io.snailuu.boot.common.vo.UploadVo;
import io.snailuu.boot.config.properties.FileProperties;
import io.snailuu.boot.config.properties.LocalFileProperties;
import io.snailuu.boot.framework.exception.UploadException;
...
import io.snailuu.boot.util.TraceIdUtil;
import io.snailuu.boot.util.api.OssApi;
