...
import io.snailuu.boot.auth.annotation.AppUserRole;
import io.snailuu.boot.auth.cache.AppLoginCache;
import io.snailuu.boot.auth.enums.LoginInterceptStrategy;
...
import io.snailuu.boot.config.properties.LoginAppProperties;
import io.snailuu.boot.framework.exception.AuthException;
