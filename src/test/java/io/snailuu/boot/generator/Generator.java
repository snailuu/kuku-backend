package io.snailuu.boot.generator;
...
import io.snailuu.boot.generator.handler.GeneratorHandler;
...
public class Generator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 包名称
        config.setPackageName("io.snailuu.boot");
        // 模块名称
        config.setModuleName("test");
        // 作者
        config.setAuthor("snailuu");
        // 生成ID类型枚举类型
        ...
        // 前端自定义代码生成绝对路径，默认为当前项目下的vue目录，可配置如：/Users/mrliu/snailuu/spring-boot-plus-vue3
