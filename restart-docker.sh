...
# 映射外部日志目录和外部文件上传目录
# docker run -p 8888:8888 -d  -v /Users/mrliu/snailuu/spring-boot-plus/docker-logs:/spring-boot-plus/logs -v /Users/mrliu/snailuu/spring-boot-plus/docker-upload:/home/spring-boot-plus/upload  --name spring-boot-plus-container spring-boot-plus
# 直接运行
...
# 查看物理主机上映射的日志
#tail -fn 500 /Users/mrliu/snailuu/spring-boot-plus/docker-logs/boot-info.log
#将日志全部导出到宿主机指定物理文件
#docker logs spring-boot-plus-container >> /Users/mrliu/snailuu/spring-boot-plus/docker-logs/spring-boot-plus.log
